  ...
  if (Serial1.available())
  {
    ...
    if (Serial1.find("+IPD,"))
    {
      ...
      if (Serial1.find("servo="))
      {
        ...
        Serial.print("recieved data from web browser trigger : ");
        Serial.println(incomingByte, DEC);
        switch (incomingByte) {
          case 108:    // your hand is on the sensor
            trigger = 1;
            break;
          case 114:    // your hand is close to the sensor
            trigger = 2;
            break;
          default:
            trigger = 0;
      ...
      String webpage = "<html><head><style>.button { background-color: #1c87c9; color: white;padding: 20px 34px; display: inline-block; margin: 4px 2px;}</style></head><body><a href=\"http://192.168.4.1/?servo=l\" class=\"button\">Move Servo CW</a><br><a href=\"http://192.168.4.1/?servo=r\" class=\"button\">Move Servo CCW</a></body></html>";
      espsend(webpage);
